...
class Shape {
    constructor(txt_string,
        ...
        shape_frame_fill = 'white',
            ...
            this.shape_xml_text_svg_str = `<text x="${this.txt_x}" y="${this.txt_y}" font-size="${this.txt_font}" `+   
                                          `text-anchor="${this.txt_anchor}" ` + 
                                          `fill="${this.txt_fill_color}">${this.txt_string}</text>`;
        ...
        renderTxt() {
            throw new Error('Child class must implement renderTxt() method');
          }
        get shape_xml_text_svg_str() {
          return this._shape_xml_text_svg_str;
        } 
        set shape_xml_text_svg_str(value) {
          this._shape_xml_text_svg_str = value;
        }   
        makeSVG(){
